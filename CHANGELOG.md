...
### Changed
- Refined budget range options: consolidated values above 15,000 into "NT$ 15,000 以上 (客製)".
- Updated budget descriptions to: 僅首頁 / 入門 / 基本 / 客製.

---
精簡了預算範圍選項，將 15,000 以上合併為客製化選項，並統一了級距說明用字。
